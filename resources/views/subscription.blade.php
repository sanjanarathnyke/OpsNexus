            ...
            <main class="content">
                <div class="page-header">
                    <div>
                        ...
                        <p>Choose the plan that best fits your team. Currently on <span class="badge badge-primary">Pro
                                Plan</span></p>
                    </div>
                    <div style="display:flex;gap:8px;align-items:center">
                        <span style="font-size:13px;color:var(--text-muted)">Billing:</span>
                        <button class="btn btn-secondary btn-sm" id="billingToggle"
                            onclick="toggleBilling()">Monthly</button>
                    </div>
                </div>
                    ...
                    <div class="card-body"
                        ...
                        <div style="display:flex;align-items:center;gap:16px">
                            ...
                            <div>
                                ...
                                <div style="font-size:13px;color:var(--text-muted)">Next billing: April 1, 2025 ·
                                    $79/month</div>
                            </div>
                        </div>
                        <div style="display:flex;gap:8px">
                            <button class="btn btn-secondary" onclick="showToast('info','Billing portal')">Manage
                                Billing</button>
                            <button class="btn btn-danger"
                                onclick="showToast('warning','Cancel confirmation dialog')">Cancel Plan</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="subscription-cards">
                    ...
                    <div class="sub-card">
                        ...
                        <button class="btn btn-secondary" style="width:100%"
                            onclick="showToast('info','Downgrade to Free plan')">Downgrade to Free</button>
                    </div>
                    ...
                    <div class="sub-card featured">
                        ...
                        <button class="btn btn-primary" style="width:100%"
                            onclick="showToast('success','You are already on Pro!')">Current Plan ✓</button>
                    </div>
                    ...
                    <div class="sub-card">
                        ...
                        <button class="btn btn-primary"
                            style="width:100%;background:linear-gradient(135deg,#8b5cf6,#4f8ef7)"
                            onclick="showToast('success','Sales team will contact you!')">Contact Sales</button>
                    </div>
                </div>
                        ...
                        <table class="data-table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="text-align:center;background:#fafcff">Unlimited</td>
                                    <td style="text-align:center">Unlimited</td>
                                </tr>
                                <tr>
                                    <td>Developer Seats</td>
                                    <td style="text-align:center">2</td>
                                    <td style="text-align:center;background:#fafcff">25</td>
                                    <td style="text-align:center">Unlimited</td>
                                </tr>
                                <tr>
                                    <td>Storage</td>
                                    <td style="text-align:center">5 GB</td>
                                    <td style="text-align:center;background:#fafcff">100 GB</td>
                                    <td style="text-align:center">2 TB</td>
                                </tr>
                                <tr>
                                    <td>Git Integration</td>
                                    <td style="text-align:center">Basic</td>
                                    <td style="text-align:center;background:#fafcff">Full</td>
                                    <td style="text-align:center">Full</td>
                                </tr>
                                <tr>
                                    <td>Payment Tracking</td>
                                    <td style="text-align:center;color:var(--text-muted)">✕</td>
                                    <td style="text-align:center;background:#fafcff;color:var(--success)">✓</td>
                                    <td style="text-align:center;color:var(--success)">✓</td>
                                </tr>
                                <tr>
                                    <td>Analytics</td>
                                    <td style="text-align:center;color:var(--text-muted)">Basic</td>
                                    <td style="text-align:center;background:#fafcff;color:var(--success)">Advanced</td>
                                    <td style="text-align:center;color:var(--success)">Advanced + Custom</td>
                                </tr>
                                <tr>
                                    <td>Support</td>
                                    <td style="text-align:center">Community</td>
                                    <td style="text-align:center;background:#fafcff">Email (24h)</td>
                                    <td style="text-align:center">Dedicated SLA</td>
                                </tr>
                                <tr>
                                    <td>Custom Integrations</td>
                                    <td style="text-align:center;color:var(--text-muted)">✕</td>
                                    <td style="text-align:center;background:#fafcff;color:var(--text-muted)">✕</td>
                                    <td style="text-align:center;color:var(--success)">✓</td>
                                </tr>
                            </tbody>
                        </table>
