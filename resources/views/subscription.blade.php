    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
            ...
            <main class="w-full grow p-6 space-y-8">
                ...
                <div class="sm:flex sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            ...
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold bg-orange-100 text-orange-800 ml-1">
                                Pro Plan
                            </span>
                        </p>
                    </div>
                    <div class="mt-4 sm:mt-0 flex items-center space-x-3 bg-white border border-gray-200 rounded-lg p-1.5 shadow-sm">
                        ...
                        <button id="billingToggle" onclick="toggleBilling()" class="inline-flex items-center px-3 py-1.5 border border-gray-200 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-gray-50 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transition-colors">
                            Monthly
                        </button>
                    </div>
                </div>
                ...
                <!-- Current Plan Status -->
                <div class="bg-white rounded-xl border border-orange-200 shadow-sm hover:shadow-md transition-shadow overflow-hidden">
                    <div class="p-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
                        <div class="flex items-center space-x-5">
                            <div class="flex-shrink-0 h-14 w-14 rounded-full bg-orange-100 flex items-center justify-center text-2xl text-orange-600 shadow-inner">
                                ⭐
                            </div>
                            <div>
                        ...
                        <div class="flex items-center space-x-3">
                            <button onclick="showToast('info','Billing portal')" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transition-colors">
                                Manage Billing
                            </button>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm flex flex-col">
                        ...
                        <div class="p-8 pt-0 mt-auto">
                            <button onclick="showToast('info','Downgrade to Free plan')" class="w-full inline-flex justify-center items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transition-colors">
                                Downgrade
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl border-2 border-orange-500 shadow-lg flex flex-col relative transform md:-translate-y-2">
                        ...
                        <div class="p-8 flex-1">
                            <h3 class="text-lg font-semibold text-orange-600">Pro</h3>
                            <div class="mt-4 flex items-baseline text-5xl font-extrabold text-gray-900">
                            ...
                            <ul role="list" class="mt-6 space-y-4">
                                <li class="flex space-x-3">
                                    <svg class="flex-shrink-0 h-5 w-5 text-orange-500" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" /></svg>
                        ...
                        <div class="p-8 pt-0 mt-auto">
                            <button onclick="showToast('success','You are already on Pro!')" class="w-full inline-flex justify-center items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-orange-600 hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transition-colors">
                                Current Plan
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="bg-orange-50 px-6 py-4 text-center text-sm font-bold text-orange-700 w-1/4 border-b-2 border-orange-200">Pro ⭐</th>
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900 text-center bg-orange-50/30">Unlimited</td>
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900 text-center bg-orange-50/30">25</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">Unlimited</td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900 text-center bg-orange-50/30">100 GB</td>
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900 text-center bg-orange-50/30">Full</td>
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-green-500 text-center bg-orange-50/30">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">Basic</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900 text-center bg-orange-50/30">Advanced</td>
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900 text-center bg-orange-50/30">Email (24h)</td>
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-400 text-center bg-orange-50/30">
                                        <svg class="mx-auto h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" /></svg>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-green-500 text-center">
                                        <svg class="mx-auto h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" /></svg>
