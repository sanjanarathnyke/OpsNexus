            ...
            <main class="w-full grow p-6 space-y-6">
                ...
                <div class="sm:flex sm:items-center sm:justify-between mb-8">
                    ...
                    <div class="mt-4 sm:mt-0">
                        <button onclick="window.location.href='{{ route('projects') }}'" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-orange-600 hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transition-colors shadow-orange-500/30">
